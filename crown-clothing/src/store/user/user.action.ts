...
import { AdditionalInformation, UserData, USER_ACTION_TYPES } from "./user.types";
...
export const signUpFailed = withMatcher((error:Error):SignUpFailure => createAction(USER_ACTION_TYPES.SIGN_UP_FAILED, error));
...
export const signOutFailed = withMatcher((error:Error):SignOutFailure => createAction(USER_ACTION_TYPES.SIGN_OUT_FAILED, error));